...
const getDaysRemaining = (endDate: Date, gameDate: Date) => 
    Math.max(0, Math.ceil((new Date(endDate).getTime() - gameDate.getTime()) / 86400000));
                ...
                <div className="p-4 overflow-y-auto space-y-3 custom-scrollbar">
                    ...
                    {constructions.map((construction, idx) => (
                        <ActivityRow 
                            ...
                            progress={calculateProgress(
                                new Date(construction.endDate.getTime() - (BUILDING_DATA[construction.buildingType].levels[playerData.buildings.find(b=>b.type===construction.buildingType)?.level || 0]?.duration || 10) * 86400000), 
                    ...
                    {playerData.activeSeminar && (
                        <ActivityRow 
                            ...
                            progress={calculateProgress(
                                new Date(playerData.activeSeminar.endDate.getTime() - (playerData.activeSeminar.type === 'seminar' ? 2 : 1) * 86400000), 
