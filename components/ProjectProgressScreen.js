...
const ProjectProgressScreen = ({ onBack, gameSpeed, setGameSpeed, project }) => {
    ...
    const renderProjectProgress = () => {
        ...
        if (project.phase === ProjectPhase.Planning) {
            ...
            hoursRemaining = Math.max(0, Math.ceil((new Date(project.scriptEndDate).getTime() - playerData.gameDate.getTime()) / (1000 * 3600)));
            ...
            currentProgress = total > 0 ? Math.min(100, (elapsed / total) * 100) : 100;
            hoursRemaining = Math.max(0, Math.ceil((new Date(project.castingEndDate).getTime() - playerData.gameDate.getTime()) / (1000 * 3600)));
            ...
            currentProgress = total > 0 ? Math.min(100, (elapsed / total) * 100) : 100;
            hoursRemaining = Math.max(0, Math.ceil((new Date(project.productionEndDate).getTime() - playerData.gameDate.getTime()) / (1000 * 3600)));
            ...
            currentProgress = total > 0 ? Math.min(100, (elapsed / total) * 100) : 100;
            hoursRemaining = Math.max(0, Math.ceil((new Date(project.postProductionEndDate).getTime() - playerData.gameDate.getTime()) / (1000 * 3600)));
