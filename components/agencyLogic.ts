import { PlayerData, Director, Actor, TalentAgency } from '../types';
...
export const findTalentsForAgency = (agency: TalentAgency, allDirectors: Director[], allActors: Actor[]): { directorIds: number[], actorIds: number[] } => {
