...
import { CastingOption, LocationOption, Genre, PostProductionOption, ExtrasOption, MovieSize, KameraOption, LichtOption, TonOption, AusstattungOption, SFXOption, CateringOption, AgeRating } from '../types';

export const MOVIE_SIZE_CONFIG: Record<MovieSize, { name: string, budgetSteps: [number, number, number], description: string, requiredTech?: string, qualityCap: number, budgetQualityPenalties: [number, number, number], budgetQualityBonuses: [number, number, number], focusPoints: [number, number, number] }> = {
    [MovieSize.B]: { 
        name: "B-Movie", 
...
export const GENRE_IDEAL_AGE_RATING: Record<Genre, AgeRating> = {
...
export const CASTING_OPTIONS: CastingOption[] = [
...
export const KAMERA_OPTIONS: KameraOption[] = [
...
export const LICHT_OPTIONS: LichtOption[] = [
...
export const AUSSTATTUNG_OPTIONS: AusstattungOption[] = [
...
export const EXTRAS_OPTIONS: ExtrasOption[] = [
...
export const EDITING_OPTIONS: PostProductionOption[] = [
...
export const MUSIC_OPTIONS: PostProductionOption[] = [
...
export const SOUND_OPTIONS: PostProductionOption[] = [
...
export const GENRE_UNLOCKS: { [key: string]: Genre } = {
...
export const TITLE_POSITIONS = ['top', 'top-center', 'center', 'bottom-center', 'bottom'] as const;
