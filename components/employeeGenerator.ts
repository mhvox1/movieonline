...
import { Employee, EmployeeType, Genre } from '../types';
...
export const generateSingleEmployee = (id: number, type: EmployeeType, reputation: number, usedPortraits: Set<string>): Employee => {
...
export const generateEmployeeMarket = (hiredIds: number[], reputation: number, allEmployees: Employee[]): Employee[] => {
    const market: Employee[] = [];
...
export const refreshEmployeeMarket = (hiredEmployees: Employee[], reputation: number): Employee[] => {
    const market: Employee[] = [];
