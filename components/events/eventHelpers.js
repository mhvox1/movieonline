...
export const applyTransaction = (data, type, category, description, amount, descriptionKey, descriptionVars) => {
    const newData = { ...data };
    if (type === 'Einnahme') {
 ...
 */
export const calculateEventCost = (capital, targetPercent) => {
