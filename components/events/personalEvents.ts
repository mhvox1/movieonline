...
import { PlayerData, MaritalStatus, RandomEvent } from '../../types';
import { personalNoteImage } from './eventHelpers';
import { femaleFirstNames, femaleLastNames, partnerProfiles, maleFirstNames, malePartnerProfiles } from '../privateLifeData';
...
export const generatePartnerEvent = (playerData: PlayerData): RandomEvent | null => {
    return null;
};

export const BREAKUP_EVENT = (partnerName: string): RandomEvent => ({
    id: 'personal_breakup',
    category: 'Personal',
...
export const PROPOSAL_ACCEPTED_EVENT = (partnerName: string): RandomEvent => ({
...
export const PROPOSAL_REJECTED_EVENT = (partnerName: string): RandomEvent => ({
...
export const WEDDING_DAY_EVENT = (title: string, text: string, playerPortraitUrl?: string, partnerPortraitUrl?: string): RandomEvent => ({
...
export const generateForcedBreakupEvent = (partnerName: string, portraitUrl: string | null): RandomEvent => {
    const scenarios = [
        {
