...
export interface ProductionMarketingCampaign {
    id: string;
    name: string;
    description: string;
    cost: number;
    hypeGain: number; // deterministischer Hype-Gewinn
    hypeStars: number; // Anzahl der Sterne für die Anzeige
    phase?: ProjectPhase; // Erforderliche Phase
    requiredTalent?: 'director' | 'mainActor';
}

export const PRODUCTION_MARKETING_CAMPAIGNS: ProductionMarketingCampaign[] = [
    {
        id: 'word_of_mouth',
        name: 'Mundpropaganda',
