...
export const CHILD_INTERACTIONS = [
    // Baby (0-2)
...
export const SECONDARY_SCHOOL_TYPES = [
    {
...
export const PARTNER_JOB_DEFINITIONS = [
...
export const PARTNER_SEARCH_OPTIONS = [
    {
        id: 'friends',
        name: 'Freunde fragen',
...
export const ACQUAINTANCE_INTERACTIONS = [
