    ...
    ...Array.from({ length: 25 }, (_, i) => ({
        ...
        actions: i % 3 === 0 ? [
        ...
        ] : i % 3 === 1 ? [
            {
                text: 'Investieren',
                value: 'invest',
                effect: { qualityModifier: 2, dynamicCostRange: [1, 2] }
            },
            {
                text: 'Ignorieren',
                value: 'ignore',
    ...
    ...Array.from({ length: 25 }, (_, i) => ({
        ...
        actions: i % 2 === 0 ? [
        ...
        ] : [
            {
                ...
                value: 'pay_forced',
                effect: { dynamicCostRange: [0.5, 1.5] }
            }
        ]
    })),
