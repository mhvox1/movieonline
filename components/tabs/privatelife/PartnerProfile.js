...
const PartnerProfile = ({ playerData, onHire, onTrain, onInteract, interactionAvailable, daysUntilInteraction, onPropose, onPlanWedding, onKinderwunsch, onBreakup, getPortraitUrl }) => {
