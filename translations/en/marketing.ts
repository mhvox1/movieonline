...
export const marketing = {
  marketing: {
    ...
    festivals: {
      ...
      ceremonyOpenings: [
        "Welcome to the most prestigious night of the year! The crème de la crème of the film industry has gathered to honor the most outstanding achievements. Tension is in the air as we wonder who will make history tonight. We look back on a fantastic film year {year}. Let the ceremony begin!",
